    ...
    int program = HC12.read();
      switch(program){
        case '0':   // program zero = default close valve
          ...
          myservo.write(10);      // 10 degrees = close for RV & FTFV
          delay(150);
          myservo.write(10);
          delay(150);
          myservo.write(10);
        ...
        case '1':   //program one = open
          ...
          myservo.write(100);       // 100 degrees = full open
          delay(150);
          myservo.write(100);
          delay(150);
          myservo.write(100);
        ...
        case '2': //program two = get load cell data
         ...
         case '3': // LBV (should also be used to test STFV!)
          ...
          break;
        case '4': //STFV
          // this was 90 degrees off last time it was checked.
          // program 4 still needs properly set up use program 3 to test STFV
